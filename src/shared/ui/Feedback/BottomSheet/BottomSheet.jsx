      ...
      {actions.map((action, index) => {
        ...
        return (
          <button
            ...
            className={`${styles.sheetBtn} ${styles[variantClass]} ${isDisabled ? styles.disabled : ''}`}
...
return (
  <Modal
    ...
    className={`${styles.sheetModal} ${className}`}
  ...
  >
    <div 
      ref={sheetRef}
      className={`${styles.sheetContainer} ${styles[snapClass]}`}
      style={sheetStyle}
      role="dialog"
      aria-modal="true"
    ...
    >
      {/* Handle */}
      {showHandle && (
        <div className={styles.sheetHandleWrapper}>
      ...
      {/* Title */}
      {title && (
        <h3 id={labelledBy} className={styles.sheetTitle}>
          {title}
        </h3>
      )}

      {/* Content */}
      <div className={styles.sheetContent} id={describedBy}>
        {children}
      </div>
