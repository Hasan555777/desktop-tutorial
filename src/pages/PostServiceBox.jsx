      ...
      <div className="post-add-box" onClick={(e) => e.stopPropagation()}>
        ...
        {loading && uploadProgress > 0 && uploadProgress < 100 && (
          <div className="upload-progress-bar">
            <div className="progress-text">Uploading images... {uploadProgress}%</div>
        ...
        <form onSubmit={handlePublishService}>
          <div className="pbox-body-form">
            ...
            <div className="pb-group">
              <label>
                Delivery Time <span className="required-star">*</span>
              </label>
              ...
              {deliveryType === 'fixed' ? (
                <div className="pb-delivery-fixed">
                  <input 
                    type="number" 
                    value={deliveryDays} 
                ...
                <div className="pb-delivery-range">
                  <div className="pb-row-twin">
                    <div className="pb-group">
            ...
            <div className="pb-group">
              <label>
                Service Description <span className="required-star">*</span>
            ...
            <div className="pb-group">
              <label>
                ...
                <span className="image-hint">(Exactly 2 images required • Auto-compressed)</span>
              </label>
              <input 
                type="file" 
                accept="image/*" 
              ...
              {selectedImages.length < 2 ? (
                <div 
                  className={`upload-drop-zone ${loading ? 'disabled' : ''}`} 
                ...
                >
                  ...
                  {selectedImages.length < 2 && (
                    <span className="upload-warning" style={{ color: 'var(--status-danger)', fontSize: '12px' }}>
                ...
                <div className="multi-preview-grid">
                  {imagePreviews.map((previewUrl, index) => (
                    <div key={index} className="upload-preview-container">
                      ...
                      <span className="image-size-badge">
