// src/pages/Inbox/ProposalModal.jsx
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (currentBalance < budget) {
        ...
        // FIX: was `okText` — every other feedback.confirm() call in the
        // codebase (DealManager, useInboxChats) uses `confirmText`. If
        // FeedbackProvider genuinely expects `okText`, revert this one
        // spot — I don't have that file to confirm either way.
