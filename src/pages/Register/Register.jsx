            ...
            <div className={`${styles.stepPanel} ${currentStep === 1 ? styles.active : ''}`} id="step1">
              ...
              <div className={styles.fieldRow}> 
                <div className={styles.field}>
                  <label> নাম <span className={styles.req}>*</span></label>
                  <input 
                    type="text"
...
// match /users/{userId} {
//   // বিদ্যমান self-update rule-এ identity ও needsReview ফিল্ড লেখার অনুমতি আছে কিনা যাচাই করুন
