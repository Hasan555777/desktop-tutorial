    ...
    <div className="wallet-actions-module">
      ...
      <div className="balance-card">
        <div className="balance-header">
          ...
          <button className="refresh-btn-small" onClick={handleRefresh} title="Refresh" aria-label="Refresh balance">
        ...
        {walletId && (
          <div className="wallet-id-row">
            ...
            <button className="copy-id-btn" onClick={handleCopyWalletId} aria-label="Copy Wallet ID">
      ...
      <div className="actions-grid">
        {mainActions.map((action) => (
          <button key={action.id} className="action-card" onClick={() => handleAction(action)} style={{ '--action-color': action.color, '--action-bg': action.bg }} aria-label={action.name}>
      ...
      <div className="more-actions-section">
        ...
        <div className="more-actions-grid">
          {moreActions.map((action) => (
            <button key={action.id} className="more-action-item" onClick={() => handleAction(action)} aria-label={action.name}>
