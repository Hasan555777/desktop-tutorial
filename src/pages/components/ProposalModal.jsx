...
export const ProposalModal = ({
  ...
  const handleSend = async () => {
    ...
    // FIX: কনভার্ট করা (সবসময় মিনিটে) ডেটা এখন একবারই বানানো হচ্ছে, এবং
    // ব্যালেন্স-কম ও ব্যালেন্স-যথেষ্ট — দুটো পাথেই এই একই finalProposalData
    // ব্যবহার হচ্ছে। আগে ব্যালেন্স কম থাকলে raw/অকনভার্টেড proposalData
    // sessionStorage-এ সেভ হতো — "দিন" ইউনিট বাছাই করে ওয়ালেট টপ-আপ করলে
    // deadline silently মিনিট হিসেবে ভুল ইন্টারপ্রেট হয়ে যেত।
    ...
    try {
      ...
      if (currentBalance < budget) {
        sessionStorage.setItem('pendingProposal', JSON.stringify({
          data: finalProposalData, // ✅ ফিক্সড — এখন কনভার্টেড ডেটা সেভ হচ্ছে
          chatId: safeChatId,
          postType,
          userRole,
          timestamp: Date.now()
