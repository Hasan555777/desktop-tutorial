      ...
      {docStatus.documentsUploaded && !hasRejectedDoc ? (
        ...
        <>
          ...
          <div className="form-group">
            <label>NID অথবা জন্ম নিবন্ধন নম্বর <span className="required">*</span></label>
            <input
              type="text"
              inputMode="numeric"
              maxLength="20"
            ...
            />
            {identityNumberError && (
              <div className="field-error show" style={{ display: 'block' }}>{identityNumberError}</div>
            )}
            <small style={{ display: 'block', marginTop: '4px', color: 'var(--text-muted, #64748b)' }}>
