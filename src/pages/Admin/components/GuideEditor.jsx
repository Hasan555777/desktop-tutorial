...
const GuideEditor = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Saving with a fresh updatedAt is what makes GuideModal.jsx show
      // this again to everyone — no separate "notify users" step needed.
    ...
    <div className="guide-editor">
      ...
      <div className="guide-tabs">
        {GUIDE_OPTIONS.map(opt => (
          <button
            key={opt.key}
            className={`guide-tab-btn ${activeKey === opt.key ? 'active' : ''}`}
      ...
      {activeOption && <p className="guide-tab-hint">{activeOption.hint}</p>}

      {loading ? (
        <div className="guide-editor-loading">
          <i className="fa-solid fa-spinner fa-spin"></i> লোড হচ্ছে...
        </div>
      ) : (
        <div className="guide-editor-form">
          <label className="guide-editor-toggle">
            <input
              type="checkbox"
          ...
          <div className="guide-steps-editor">
            ...
            {guide.steps.map((step, idx) => (
              <div className="guide-step-row" key={idx}>
                <div className="guide-step-controls">
                  ...
                  <button onClick={() => removeStep(idx)} className="btn-remove-step" title="ডিলিট করুন">
                ...
                <input
                  type="text"
                  className="guide-step-icon-input"
                  value={step.icon}
                ...
                <div className="guide-step-fields">
                  <input
                    type="text"
                    value={step.title}
          ...
          <button className="btn-save-guide" onClick={handleSave} disabled={saving}>
            {saving ? (
