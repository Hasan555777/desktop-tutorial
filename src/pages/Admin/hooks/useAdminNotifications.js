...
export const useAdminNotifications = () => {
  const { notify, showNotification, hasPermission, requestPermission } = useNotification();
  ...
  }, [hasPermission, requestPermission, playSoundForNotification, showAdminBrowserNotification]);
