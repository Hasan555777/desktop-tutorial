...
const NotificationModal = ({ notification, onClose }) => {
  ...
  return (
    <div className={styles.notificationModalOverlay} onClick={handleClose}>
      <div className={styles.notificationModal} onClick={(e) => e.stopPropagation()}>
        
        {/* ── হেডার ── */}
        <div className={styles.modalHeader}>
          <div className={styles.modalIconWrapper} style={{ background: `${color}15` }}>
        ...
        <div className={styles.modalBody}>
          <div className={styles.notificationDetail}>
            ...
            <div className={styles.detailItem}>
              ...
              <span className={styles.detailValue}>{formatDate(notification.createdAt)}</span>
            </div>
            ...
            {notification.message && (
              <div className={styles.detailItem}>
                ...
                <span className={`${styles.detailValue} ${styles.messageText}`}>{notification.message}</span>
              </div>
            )}
            ...
            {notification.type && (
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>
                  <span className={styles.typeBadge} style={{ background: `${color}15`, color: color }}>
            ...
            <div className={styles.detailItem}>
              ...
              <span className={styles.detailValue}>
                ...
                {!isRejected && !isPending && !isApproved && notification.type && (
                  <span className={`${styles.statusBadge} ${styles.info}`}>ℹ️ {notification.type.toUpperCase()}</span>
                )}
              </span>
            </div>
            ...
            {notification.userId && (
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>{notification.userId}</span>
              </div>
            )}
            ...
            {notification.dealId && (
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>{notification.dealId}</span>
              </div>
            )}
        ...
        <div className={styles.modalFooter}>
          ...
          {notification.dealId && (
            <button 
              className={`${styles.btnAction} ${isNavigating ? styles.loading : ''}`} 
