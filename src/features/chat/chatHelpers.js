...
import { ACTIVE_DEAL_STATUSES } from '../../shared/rules/dealRules';
...
// ============================================================
// 🔧 ADD (edit-scope fix): shared placeholder text used as the
// `text` field for image messages that were sent with no caption.
// Both useChatMessages.js (writes it) and MessageList.jsx (checks
// for it before rendering a caption line) import this instead of
// each hardcoding the same string — previously duplicated, which is
// exactly the kind of drift that made the "editing an image does
// nothing" bug hard to spot.
// ============================================================
export const AUTO_IMAGE_CAPTION = "📷 Shared an image";
