...
export const useAccessControl = () => {
  ...
  // 🔧 ADD (Disable Admin requirement): exposed so PrivateRoute/
  // NotificationProvider can pass this into isAdminUser()/
  // hasAdminPermission() (constants/admin.js) — a sub-admin with
  // adminDisabled: true loses admin access without their role or
  // adminPermissions being touched (distinct from a full removal).
  const adminDisabled = !!userData?.adminDisabled;
  ...
  return {
    ...
    userRole,
    statusLabel, // 🔥 নতুন
    adminDisabled, // 🔧 ADD (Disable Admin requirement)
