...
const ToastItem = React.memo(({
  ...
  return (
    <div
      className={`toast-item ${positionClass} ${variantClass} ${isVisible ? 'toast-enter' : ''} ${isExiting ? 'toast-exit' : ''} ${className}`}
      role="alert"
      aria-live="polite"
      aria-atomic="true"
    ...
    >
      <div className="toast-content">
        {/* Icon */}
        <div className={`toast-icon ${variantClass}`}>
      ...
      {showProgress && duration > 0 && (
        <div className="toast-progress">
          <div
            className={`toast-progress-bar ${variantClass}`}
...
const Toast = React.memo(({
  ...
  const containerContent = (
    <div
      className={`toast-container ${POSITIONS[position] || POSITIONS[DEFAULT_POSITION]} ${className}`}
      style={{ zIndex }}
      role="region"
