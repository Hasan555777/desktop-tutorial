  ...
  return (
    ...
    >
      <div className="progress-container">
        {/* Icon */}
        <div className={`progress-icon ${animated && !isComplete ? 'animated' : ''}`}>
        ...
        >
          <div className="progress-bar">
            <div 
              className={`progress-fill ${isComplete ? 'complete' : ''} ${animated ? 'animated' : ''}`}
        ...
        <div className="progress-footer">
          {showPercent && !isComplete && (
            <span className="progress-text">{displayValue}%</span>
          )}
          
          {isComplete && showCompleted && (
            <span className="progress-text complete">
