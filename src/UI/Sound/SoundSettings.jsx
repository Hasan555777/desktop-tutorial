...
const SoundSettings = ({ 
  ...
  if (isLoading) {
    return (
      <div className={`sound-settings ${variant}`}>
        <div className="sound-settings-body" style={{ padding: '16px', textAlign: 'center' }}>
          <span className="loading-text">Loading sound settings...</span>
        </div>
      </div>
    );
  }
  ...
  if (variant === 'admin') {
    return (
      <div className="sound-settings admin-sound-settings">
        <div className="sound-settings-header" onClick={() => setIsExpanded(!isExpanded)}>
          <div className="sound-settings-title">
          ...
          <div className="sound-settings-status">
            <span className={`status-dot ${isMuted ? 'muted' : 'active'}`}></span>
        ...
        {isExpanded && (
          <div className="sound-settings-body">
            ...
            <div className="sound-setting-item">
              ...
              <button 
                className={`mute-toggle ${isMuted ? 'muted' : 'active'}`}
                onClick={toggleMute}
            ...
            <div className="sound-setting-item">
              <div className="setting-label">
                ...
                <span className="setting-label-text">Volume: <strong>{volume}%</strong></span>
              </div>
              <input
                type="range"
                min="0"
            ...
            {/* Test Sound */}
            <div className="sound-setting-item test-sound-item">
              <div className="setting-label">
                <i className="fa-solid fa-play"></i>
                <span className="setting-label-text">Test Sound</span>
              </div>
              <div className="test-sound-controls">
                <select 
                  value={selectedTestSound}
                  onChange={(e) => setSelectedTestSound(e.target.value)}
                  className="test-sound-select"
                  disabled={isMuted}
                >
            ...
            {/* Sound Status */}
            <div className="sound-status-bar">
              <div className="status-item">
                <span className="status-label">Status:</span>
                <span className={`status-value ${isMuted ? 'muted' : 'active'}`}>
                  {isMuted ? '🔇 Muted' : '🔊 Active'}
                </span>
              </div>
              <div className="status-item">
                <span className="status-label">Volume:</span>
                <span className="status-value">{volume}%</span>
              </div>
            </div>
          </div>
        )}
